...
public class TestSimpleOomage {
    ...
    /**
     * 1. Store all combs of rgbs in an array
     * 2. assert that none of two elements with distinct index
    ...
    public void testHashCodePerfect() {
         ...
         */
        SimpleOomage[] oos = new SimpleOomage[52 * 52 * 52];
        int count = 0;
        for (int i = 0; i < 52; i += 1) {
            for (int j = 0; j < 52; j += 1) {
                for (int k = 0; k < 52; k += 1) {
                    SimpleOomage ooa = new SimpleOomage(i * 5, j * 5, k * 5);
                    oos[count] = ooa;
                    count += 1;
                }
            }
